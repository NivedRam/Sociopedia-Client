...
const Form = () => {
  ...
  const register = async (values, onsubmitprops) => {
    try {
      ...
      const savedUser = await savedUserResponce.json();
  ...
  const login = async (values, onsubmitprops) => {
    try {
      ...
      const {data} = await axios.post(
        "http://localhost:8080/auth/login",values
        // {
        //   method: "POST",
      ...
      // const {loggedIn} = await loggedInUserResponce.json();
      onsubmitprops.resetForm();
  ...
  return (
    <Formik
      ...
      initialValues={isLogin ? initialValueLogin : initialValueRegistration}
            ...
            {isRegister && (
              <>
                ...
                <TextField
                  ...
                  helperText={touched.lastName && errors.lasstName}
                  sx={{ gridColumn: "span 2" }}
                />
                <TextField
                  label="Location"
